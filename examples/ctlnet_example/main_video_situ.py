...
def image_generation_process(
    ...
    ######################################################
    adapter = True
    ip_adapter_image_filepath = "assets/xshingosit-0011.jpg"
...
def main(
    model_id_or_path: str = "Lykon/dreamshaper-8-lcm",
    lora_dict: Optional[Dict[str, float]] = {"./models/LoRA/xshingositu.safetensors": 0.9},
    prompt: str = "xshingositu",
